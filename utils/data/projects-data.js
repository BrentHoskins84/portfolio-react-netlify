...
export const projectsData = [
    ...
    },
    {
        ...
        description: 'While working at Three29 LLC, I had the opportunity to rebuild the Capital Morning Report (CMR) app, which had initially been developed by our team. This project involved modernizing the app and adding new features, including a key functionality for monitoring and tracking when users take screenshots.',
        tools: ['React Native', 'NativeWind', "Google Maps API", "React Native Screenshot Prevent", "React Native Navigation", "MySQL", 'Reanimated 2', "Jest",],
        role: 'Full Stack Developer',
        code: '',
        demo: '',
    },
